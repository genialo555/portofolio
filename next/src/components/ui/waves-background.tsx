...
export function WavesBackground({ isMenuOpen }: WavesBackgroundProps) {
  return (
    <div className={cn(
      "absolute inset-0 transition-all duration-500 ease-in-out",
      isMenuOpen ? "w-1/2" : "w-full"
    )}>
      <div className="absolute inset-0 z-[1800]">
        <Waves
          lineColor="rgba(255, 0, 0, 0.3)"
          backgroundColor="transparent"
          className="z-[1800] animate-wave-pulse absolute inset-0 translate-x-[2px]"
          isMouseEnabled={!isMenuOpen}
        />
        <Waves
          lineColor="rgba(0, 255, 0, 0.3)"
          backgroundColor="transparent"
          className="z-[1800] animate-wave-pulse absolute inset-0 translate-x-[1px]"
          isMouseEnabled={!isMenuOpen}
        />
        <Waves
          lineColor="rgba(0, 0, 255, 0.3)"
          backgroundColor="transparent"
          className="z-[1800] animate-wave-pulse absolute inset-0"
          isMouseEnabled={!isMenuOpen}
        />
      </div>
    </div>
