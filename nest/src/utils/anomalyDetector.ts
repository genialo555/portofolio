...
export class AnomalyDetectorService {
   ...
   */
  private detectCognitiveBiases(poolOutputs: PoolOutputs): Anomaly[] {
    const anomalies: Anomaly[] = [];
    const biasPatterns = [
      { 
  ...
  /**
   * Détecte les problèmes méthodologiques dans les réponses
   */
  private detectMethodologicalFlaws(poolOutputs: PoolOutputs): Anomaly[] {
    const anomalies: Anomaly[] = [];
   ...
   */
  private detectStatisticalErrors(poolOutputs: PoolOutputs): Anomaly[] {
    const anomalies: Anomaly[] = [];
   ...
   */
  private detectCitationIssues(poolOutputs: PoolOutputs): Anomaly[] {
    const anomalies: Anomaly[] = [];
