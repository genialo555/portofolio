...
// Configuration des agents du pool Éducatif
export const educationalAgents: AgentConfig[] = [
  {
    id: 'edu-agent-1',
    name: 'Agent Éducatif Général',
    type: AgentType.EDUCATIONAL,
    ...
    description: 'Agent spécialisé dans la pédagogie générale et la transmission de connaissances fondamentales'
  },
  {
    id: 'edu-agent-2',
    name: 'Agent Éducatif Interactif',
    type: AgentType.EDUCATIONAL,
    api: ApiProvider.HOUSE_MODEL,
    parameters: {
      temperature: 0.6,
    ...
    description: 'Agent spécialisé dans l\'apprentissage interactif et les exercices pratiques'
  },
  {
    id: 'edu-agent-3',
    name: 'Agent Éducatif Spécialisé',
    type: AgentType.EDUCATIONAL,
    api: ApiProvider.HOUSE_MODEL,
    parameters: {
      temperature: 0.3,
    ...
    description: 'Agent spécialisé dans les domaines techniques et les connaissances avancées'
  },
  {
    id: 'edu-agent-4',
    name: 'Agent Éducatif Junior',
    type: AgentType.EDUCATIONAL,
    api: ApiProvider.HOUSE_MODEL,
    parameters: {
      temperature: 0.5,
    ...
    description: 'Agent adapté aux jeunes apprenants avec des explications simplifiées et ludiques'
  }
];
